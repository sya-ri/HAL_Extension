...
- [ADC_DMA](class/ADC_DMA.md)
  ...
  - [関数](class/ADC_DMA.md#関数)
    - [getHandle()](class/ADC_DMA.md#adc_dmagethandle)
    - [equals(ADC_HandleTypeDef*)](class/ADC_DMA.md#adc_dmaequalsadc_handletypedef)
    - [equals(ADC_HandleTypeDef&)](class/ADC_DMA.md#adc_dmaequalsadc_handletypedef-1)
