...
- [UART](class/UART.md)
  ...
  - [関数](class/UART.md#関数)
    - [getHandle()](class/UART.md#uartgethandle)
    - [equals(UART_HandleTypeDef*)](class/UART.md#uartequalsuart_handletypedef)
    - [equals(UART_HandleTypeDef&)](class/UART.md#uartequalsuart_handletypedef-1)
...
- [UART_IT](class/UART_IT.md)
  ...
  - [関数](class/UART_IT.md#関数)
    - [getHandle()](class/UART_IT.md#uart_itgethandle)
    - [equals(UART_HandleTypeDef*)](class/UART_IT.md#uart_itequalsuart_handletypedef)
    - [equals(UART_HandleTypeDef&)](class/UART_IT.md#uart_itequalsuart_handletypedef-1)
...
- [UART_DMA](class/UART_DMA.md)
  ...
  - [関数](class/UART_DMA.md#関数)
    - [getHandle()](class/UART_DMA.md#uart_dmagethandle)
    - [equals(UART_HandleTypeDef*)](class/UART_DMA.md#uart_dmaequalsuart_handletypedef)
    - [equals(UART_HandleTypeDef&)](class/UART_DMA.md#uart_dmaequalsuart_handletypedef-1)
...
- [UART_Logger](class/UART_Logger.md)
  ...
  - [関数](class/UART_Logger.md#関数)
    - [getHandle()](class/UART_Logger.md#uart_loggergethandle)
    - [equals(UART_HandleTypeDef*)](class/UART_Logger.md#uart_loggerequalsuart_handletypedef)
    - [equals(UART_HandleTypeDef&)](class/UART_Logger.md#uart_loggerequalsuart_handletypedef-1)
...
- [UART_Logger_IT](class/UART_Logger_IT.md)
  ...
  - [関数](class/UART_Logger_IT.md#関数)
    - [getHandle()](class/UART_Logger_IT.md#uart_logger_itgethandle)
    - [equals(UART_HandleTypeDef*)](class/UART_Logger_IT.md#uart_logger_itequalsuart_handletypedef)
    - [equals(UART_HandleTypeDef&)](class/UART_Logger_IT.md#uart_logger_itequalsuart_handletypedef-1)
