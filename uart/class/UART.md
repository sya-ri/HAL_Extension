...
- [関数](#関数)
  - [getHandle()](#uartgethandle)
  - [equals(UART_HandleTypeDef*)](#uartequalsuart_handletypedef)
  - [equals(UART_HandleTypeDef&)](#uartequalsuart_handletypedef-1)
...
##### UART::equals(UART_HandleTypeDef*)
##### UART::equals(UART_HandleTypeDef&)
> ```c++
> bool equals(
>     UART_HandleTypeDef *huart
